            ...
            <div className="mx-auto max-w-[1200px]">
                ...
                <div className="grid gap-8 md:grid-cols-3">
                    {plans.map((plan, idx) => (
                        <div
                            key={idx}
                            className={`relative rounded-xl border transition-all ${plan.highlighted
                        ...
                        >
                            ...
                            <div className="p-8">
                                ...
                                <button
                                    className={`mb-8 w-full rounded-lg py-3 font-semibold transition-all ${plan.highlighted
